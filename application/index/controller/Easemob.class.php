...
//------------------------------------------------------用户体系    
     ...
     * 	public static String APP_KEY = "1112190521107261#breast";
        public static String APP_CLIENT_ID = "YXA6_ZcfsJtBEemw8oHuFF6puw";
        public static String APP_CLIENT_SECRET = "YXA6ha-TF635wlOUQuvA7NNrlSK0LlA";
     */
    public function __construct($options)
    {
        $this->client_id = isset ($options ['client_id']) ? $options ['client_id'] : 'YXA6_ZcfsJtBEemw8oHuFF6puw';
        $this->client_secret = isset ($options ['client_secret']) ? $options ['client_secret'] : 'YXA6ha-TF635wlOUQuvA7NNrlSK0LlA';
